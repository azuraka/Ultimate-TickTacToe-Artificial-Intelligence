...
def min_max(temp_board, temp_block,flag, cells):
	...
	for i in boards_level1:
		...
		for j in cells_allowed_level1[boards_level1.index(i)]:
			...
			temp_cells_allowed.append(cells_allowed(parent_level1,temp_block,j,flag))	#saurabh What should be temp_block here?
			temp_list_tuple.append(j)
			temp_list.append(parent_level1)
		cells_allowed_level2.append(temp_cells_allowed)		#saurabh
	...
	for i in boards_level2:
		...
		for j in i:
			temp_list=[]
			temp_list_prob=[]
			for k in cells_allowed_level2[boards_level2.index(i)]:
				for m in k:
					parent_level2=[]
					for l in xrange(0,9):
						temp = copy.copy(j[l])
						parent_level2.append(temp)
					parent_level2[m[0]][m[1]] = 'x'
					prob = random.randint(0,500)
					temp_list.append(parent_level2)
					temp_list_prob.append(prob)
			temp_list2.append(temp_list)
			temp_list2_prob.append(temp_list_prob)
		boards_level3.append(temp_list2)
		probability_level3.append(temp_list2_prob)
	#print boards_level3

	probability_level2=[]
	for i in probability_level3:
		for j in i:
			temp = max(j)
			temp_list.append(temp)
		probability_level2.append(temp_list)


	#probability_level3=[]
	#for i in boards_level3:
	#	for j in i:
	#		temp_list=[]
	#		for k in j:
	#			prob = random.randint(0,500)
	...
	#		temp_list2.append(temp_list)
	#	probability_level3.append(temp_list2)
	#print probability_level3
#######################################################
